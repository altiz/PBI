...
BEGIN
    ...
    INSERT INTO pbi.VALUE_PLAN (MAIN_ID,  VALUE, "YEAR", IS_CURR)
        ...
        GROUP BY  COB_ID,
            ...
            financing_source_id),
        sum_trans AS (
        SELECT financing_source_id, COB_ID, M_DATE, TITLE_NUMBER, NULLIF(VALUE_CURR_1,0) AS VALUE, M_YEAR AS YEAR, 1 AS IS_CURR FROM curr_sum
        UNION ALL
        SELECT financing_source_id, COB_ID, M_DATE, TITLE_NUMBER, NULLIF(VALUE_CURR_2,0) AS VALUE, M_YEAR+1, null FROM curr_sum
        UNION ALL
